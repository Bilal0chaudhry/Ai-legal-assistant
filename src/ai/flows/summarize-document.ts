'use server';
/**
 * @fileOverview Summarizes a legal document using the Gemini API.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a legal expert. Summarize the key points of the following legal document in a concise manner.\n\nDocument: {{media url=documentDataUri}}`,
});
